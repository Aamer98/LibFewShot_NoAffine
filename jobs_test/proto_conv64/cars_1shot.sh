...
#SBATCH --job-name=proto_conv64_cars_1shot
...
cd ..
python run_test.py --data_root ./dataset/StanfordCar --weight-root ./results/ProtoNet-miniImageNet--ravi-Conv64F-5-1-Nov-10-2021-05-19-50


python run_test.py --data_root ./dataset/StanfordCar --weight-root ./results/ProtoNet-miniImageNet--ravi-Conv64F-5-5-Nov-10-2021-11-17-21
