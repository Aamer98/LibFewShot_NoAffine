...
#SBATCH --job-name=proto_conv64_=ISIC_1shot
...
cd ..
python run_test.py --data_root ./dataset/ISIC --weight-root ./results/ProtoNet-miniImageNet--ravi-Conv64F-5-1-Nov-10-2021-05-19-50


python run_test.py --data_root ./dataset/ISIC --weight-root ./results/ProtoNet-miniImageNet--ravi-Conv64F-5-5-Nov-10-2021-11-17-21
