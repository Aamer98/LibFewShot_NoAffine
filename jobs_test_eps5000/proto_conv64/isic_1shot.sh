...
cd ..
python run_test_5000.py --data_root ./dataset/ISIC


#python run_test_eps600.py --data_root ./dataset/ISIC --weight_root ./results/ProtoNet-miniImageNet--ravi-Conv64F-5-5-Nov-10-2021-11-17-21
